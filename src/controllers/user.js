...
//
// This file holds every user-account controller action: registering,
// logging in/out, the logged-in dashboard, and the admin-only Users
// list. All of it is "user" logic (creating/authenticating/listing
// app_user rows), so it lives together here instead of being split
// across a separate authController.js and userController.js.
